...
def agendamentos():
    ...
    # Agrupar em dict por data
    agendamentos_por_data = defaultdict(list)
    for ag in lista:
        agendamentos_por_data[ag.data].append({
            "id": ag.id,
            "nome": ag.nome,
    ...
    return render_template("agendamentos.html", agendamentos_por_data=agendamentos_por_data, agendamentos=lista)
